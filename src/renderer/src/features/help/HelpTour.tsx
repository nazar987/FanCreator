...
const STEPS: TourStep[] = [
  {
    ...
    title: 'Библиотека',
    text: 'На главной здесь лежат проекты, а внутри проекта — полка историй. Это безопасная точка старта.'
  },
  {
  ...
  },
  {
    ...
    title: 'Персонажи',
    text: 'Здесь ведутся анкеты героев, теги, поля и шаблоны. Выбор нескольких персонажей нужен для массового применения шаблона.'
  },
  {
    selector: '[data-tour="board"]',
    title: 'Доска',
    text: 'Доска работает как пространство для заметок, текста, фигур, картинок и связей между элементами.'
  },
  {
    selector: '[data-tour="timeline"]',
    title: 'Таймлайн',
    text: 'Таймлайн хранит события истории: можно вести список, смотреть «рыбью кость» и отправлять схему на доску.'
  },
  {
